...
import type { AddressErrors, ProfileDetailsTexts, ProfileFormState, ProfileSummaryRow } from '../types';
...
export function UserProfileDetailsManager({
  ...
  const handleRemoveSecondaryAddress = (index: number) => {
    ...
    setSavedAddressErrors((current) => current.filter((_, currentIndex) => currentIndex !== index));
    ...
    <>
      {showSummary && (
        <UserProfileDetailsSummary
          eyebrow={detailTexts?.eyebrow ?? 'Profile details'}
          editButtonLabel={detailTexts?.editButton ?? 'Edit profile'}
          tableAriaLabel={detailTexts?.tableAriaLabel ?? 'Profile details'}
          rows={summaryRows}
          ...
          secondaryForm={{
            ...
            isSecondaryOnlyExpanded: isAddingSecondaryAddress,
            showSecondaryOnlyPrompt: true,
            onFieldChange: handleFieldChange,
            onPrimaryAddressChange: handlePrimaryAddressChange,
            onSavedAddressChange: handleSavedAddressChange,
            onAddSecondaryAddress: handleStartSecondaryAddress,
