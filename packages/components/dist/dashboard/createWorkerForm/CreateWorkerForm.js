  ...
  return _jsxs('section', {
    ...
    children: [
      _jsxs('form', {
        ...
        children: [
          _jsx('h2', { children: 'Crear Trabajador' }),
          _jsx('input', {
            type: 'text',
            name: 'name',
            placeholder: 'Nombre',
          ...
          _jsxs('select', {
            ...
            children: [
              _jsx('option', { value: 'EMPLOYEE', children: 'Empleado' }),
              _jsx('option', { value: 'CONTRACTOR', children: 'Contratista' }),
            ],
          }),
          _jsx('input', {
            type: 'date',
          ...
          _jsxs('select', {
            ...
            children: [
              _jsx('option', { value: 'HOURLY', children: 'Por hora' }),
              _jsx('option', { value: 'SALARIED', children: 'Salario mensual' }),
            ],
          }),
          ...
          _jsxs('select', {
            ...
            onChange: handleChange,
            children: [
              _jsx('option', { value: 'de', children: 'Deutsch' }),
          ...
          _jsx('button', {
            type: 'submit',
            disabled: loading,
            children: loading ? 'Creando...' : 'Crear trabajador',
          }),
        ],
      }),
      alert &&
