...
const ThemeToggler = () => {
    ...
    return (<button className={`${styles.toggleButton} ${theme === 'dark' ? styles.dark : ''}`} onClick={toggleTheme} aria-label="Toggle theme">
      <div className={styles.iconsWrapper}>
        <span className={styles.moon}>
          <Image className={styles.logo} src="/svg/moon.svg" alt="Moon icon" width={30} height={30}/>
        </span>
