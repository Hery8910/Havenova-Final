...
const SkeletonWelcomeOfferBanner = () => {
    return (<section className={`${styles.section} ${styles.skeletonCard}`} aria-busy="true" aria-live="polite">
      <div className={`${styles.image} ${styles.skelMedia} ${styles.animShimmer}`} aria-hidden="true"/>
