...
export default function BlogCard({ blog, isPreview }) {
    return (<section className={isPreview ? styles.preview_section : styles.section}>
      <main className={styles.main}>
        <h3 className={styles.h3}>
          {blog.title || 'The title will appear as the main headline of your blog post.'}
        </h3>
        {isPreview && (<p className={styles.p}>
            {blog.introduction ||
      ...
      <Image className={isPreview ? styles.preview_image : styles.image} src={blog.featuredImage || '/images/blog-image-mock.webp'} priority={true} alt={blog.title || 'Image'} width={200} height={95}/>
    </section>);
}
