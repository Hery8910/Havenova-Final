  ...
  return (
    <section className={styles.card} aria-labelledby="user-preferences-title">
      <section className={styles.wrapper}>
        <h3 id="user-preferences-title" className={`type-title-sm ${styles.title}`}>
          {title}
        </h3>
        <aside className={styles.aside} aria-labelledby="user-preferences-language-title">
          <div className={styles.labelWrapper}>
            ...
            <p className={`${styles.langLabel} type-body-lg`}>{languageTitle}</p>
          </div>
        ...
        <aside className={styles.aside} aria-labelledby="user-preferences-theme-title">
          <div className={styles.labelWrapper}>
            ...
            <p className={`${styles.langLabel} type-body-lg`}>{themeTitle}</p>
          </div>
        ...
        <aside className={styles.aside} aria-labelledby="user-preferences-cookies-title">
          <div className={styles.labelWrapper}>
            ...
            <p className={`${styles.langLabel} type-body-lg`}>{cookiesTitle}</p>
          </div>
          <div className={styles.switchWrapper}>
            <button
              type="button"
              className={`${styles.cookieButton} button button--outline`}
              onClick={onOpenCookies}
            >
              <MdOutlineCookie aria-hidden />
              <span className="type-body-sm">{cookiesButtonLabel}</span>
            </button>
          </div>
        </aside>
      </section>
      ...
      >
        <fieldset className={styles.notificationsFieldset}>
          <div className={styles.notificationsIntro}>
          ...
          <div className={styles.notificationRows}>
            <article className={styles.notificationRow}>
              <div className={styles.notificationCopy}>
                ...
                <article className={styles.notificationArticle}>
