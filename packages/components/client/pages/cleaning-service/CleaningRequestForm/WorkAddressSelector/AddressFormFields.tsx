...
export default function AddressFormFields({
  ...
  const getDescribedBy = (field: keyof UserAddress) => (errors?.[field] ? getErrorId(field) : undefined);
  ...
  return (
    ...
    >
      <label className={`${styles.field} ${styles.streetField}`}>
        ...
        />
        {errors?.street && (
          <span className="error" id={getErrorId('street')}>
            {errors.street}
          </span>
        )}
      </label>
      ...
      <label className={`${styles.field} ${styles.streetNumberField}`}>
        ...
        />
        {errors?.streetNumber && (
          <span className="error" id={getErrorId('streetNumber')}>
            {errors.streetNumber}
          </span>
        )}
      </label>
      ...
      <label className={`${styles.field} ${styles.postalCodeField}`}>
        ...
        />
        {errors?.postalCode && (
          <span className="error" id={getErrorId('postalCode')}>
            {errors.postalCode}
          </span>
        )}
      </label>
      ...
      <label className={`${styles.field} ${styles.districtField}`}>
        ...
        />
        {errors?.district && (
          <span className="error" id={getErrorId('district')}>
            {errors.district}
          </span>
        )}
      </label>
      ...
      <label className={`${styles.field} ${styles.floorField}`}>
        ...
        />
        {errors?.floor && (
          <span className="error" id={getErrorId('floor')}>
            {errors.floor}
          </span>
        )}
      </label>
