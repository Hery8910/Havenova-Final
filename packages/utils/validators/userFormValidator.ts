...
export const validateName = (name: string): string[] => {
  ...
  else if (!/^[A-Z][a-zA-Z- äöü' ]{1,49}$/.test(name.trim()))
    errors.push("invalid");
  return errors;
};
...
export const validatePhone = (phone: string): string[] => {
  ...
  else if (!/^(\+49|0)\d{8,12}$/.test(phone))
    errors.push("invalid");
  return errors;
};
...
export const validateAddress = (address: string): string[] => {
  ...
  else if (!/^[a-zA-Z0-9\s,'-.#]{5,49}$/.test(address.trim()))
    errors.push("invalid");
  return errors;
};
...
export const validateServiceAddress = (serviceAddress: string): string[] => {
  ...
  else if (!/^[a-zA-Z0-9\s,'-.#]{5,49}$/.test(serviceAddress.trim()))
    errors.push("invalid");
  return errors;
};
