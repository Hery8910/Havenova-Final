...
Register the visible states of the worker `set-password` flow, including the invitation variant.
...
For worker onboarding, the invitation mode is the primary contract.
